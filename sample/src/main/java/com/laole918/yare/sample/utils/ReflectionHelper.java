package com.laole918.yare.sample.utils;
    ...
    public static void forceAccessible(AccessibleObject member) {
        ...
        if (override == null) {
            override = getField(
                    ...
                    Build.VERSION.SDK_INT >= Build.VERSION_CODES.N ? "override" : "flag"
            );
        }
    ...
    public static Method getMethod(Class<?> c, String name, Class<?>... paramTypes) {
        ...
        if (method == null) {
            throw new IllegalArgumentException(
                    "No method " + name + " with params " + Arrays.toString(paramTypes) + " found in " + c
            );
        }
        return method;
    }
